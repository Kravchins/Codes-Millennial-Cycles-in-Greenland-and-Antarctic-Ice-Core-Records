...
This script was tested to run in Matlab R2024a with dependencies on the wavelet toolbox and SST toolbox from https://github.com/ebrevdo/synchrosqueezing/tree/master
